...
[Tasks]
Name: "associate_md"; Description: "Set PinkDown as the default app for .md files"; GroupDescription: "File associations:"; Flags: checkedonce

[Registry]
Root: HKA; Subkey: "Software\Classes\.md"; ValueType: string; ValueName: ""; ValueData: "{#MarkdownProgId}"; Flags: uninsdeletevalue; Tasks: associate_md
Root: HKA; Subkey: "Software\Classes\.md\OpenWithProgids"; ValueType: string; ValueName: "{#MarkdownProgId}"; ValueData: ""; Flags: uninsdeletevalue; Tasks: associate_md
...
[Run]
Filename: "ms-settings:defaultapps?registeredAppUser=PinkDown"; Description: "Confirm PinkDown as the default app for .md files"; Flags: shellexec postinstall skipifsilent nowait; Tasks: associate_md
